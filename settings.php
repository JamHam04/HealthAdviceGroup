...
<body>
    ...
    <div class="section px-3 fs-1 bg-light">
    <h1>Accessibility Options</h1>
        <!-- Basic switch that can be used to recieve enabled and disabled inputs-->
        <div class="form-check form-switch">
        <label class="form-check-label" for="sizeswitch">Increase Font Size</label>
        <input class="form-check-input" id="sizeswitch" type="checkbox" role="switch">
        
</div>
        <p>Adjust font colour</p>
